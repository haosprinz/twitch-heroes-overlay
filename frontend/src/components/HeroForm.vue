...
const fontSize = ref(props.hero?.fontSize ?? 14);
...
function submit() {
  ...
  emit("save", {
    name,
    config: { ...config.value, name, size: 1 },
    bubbleColor: bubbleColor.value,
    fontColor: fontColor.value,
    fontSize: fontSize.value,
    bubbleDuration: bubbleDuration.value,
